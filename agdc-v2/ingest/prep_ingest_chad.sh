...
datacube -v dataset add -t ls7_ledaps_utm33_scene  ${data_path}/${sceneid};
datacube -v ingest -c /home/localuser/agdc-v2/ingest/ingestion_configs/ls7_sr_scenes_wgs84_lake_chad.yaml

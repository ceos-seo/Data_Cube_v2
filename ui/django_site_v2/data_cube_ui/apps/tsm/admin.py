...
from .models import Query, Metadata, Result, Satellite, ResultType, Area, AnimationType
...
class ResultAdmin(admin.ModelAdmin):
    list_display = ('data_path','status','latitude_min','latitude_max','longitude_min','longitude_max','latitude_max','latitude_min','longitude_max','longitude_min')
...
class AnimationTypeAdmin(admin.ModelAdmin):
...
admin.site.register(AnimationType, AnimationTypeAdmin)
